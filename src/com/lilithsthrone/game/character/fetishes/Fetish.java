...
public class Fetish {
	...
	public static AbstractFetish FETISH_ANAL_GIVING = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>anal tease</span>",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>buttslut tease</span>"),
			null) {
		@Override
	...
	public static AbstractFetish FETISH_VAGINAL_GIVING = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>pussy worship tease</span>",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>pussy slut tease</span>"),
			null) {
		@Override
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
	...
	public static AbstractFetish FETISH_VAGINAL_RECEIVING = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>pussy slut tease</span> (Requires vagina)",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>pussy worship tease</span>"),
			null) {
	...
	public static AbstractFetish FETISH_BREASTS_SELF = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>breasts tease</span> (Requires breasts)",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>breasts lover tease</span>"),
			null) {
	...
	public static AbstractFetish FETISH_LACTATION_OTHERS = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>milk-lover tease</span>",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>lactation tease</span>"),
			null) {
		@Override
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
	...
	public static AbstractFetish FETISH_LACTATION_SELF = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>lactation tease</span> (Requires breasts)",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>milk-lover tease</span>"),
			null) {
	...
	public static AbstractFetish FETISH_STRUTTER = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>strutter tease</span> (Requires legs)",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>leg lover tease</span>"),
			null) {
	...
	public static AbstractFetish FETISH_FOOT_GIVING = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>dominant foot tease</span>",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>submissive foot tease</span>"),
			null) {
		@Override
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
	...
	public static AbstractFetish FETISH_ARMPIT_GIVING = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>armpit worship tease</span>",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>armpit slut tease</span>"),
			null) {
		@Override
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(love)] nothing more than to pleasure [npc.her] partner's armpits, and even prefers it to penetrative sexual acts.");
			}
		}
	...
	public static AbstractFetish FETISH_ARMPIT_RECEIVING = new AbstractFetish(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(love)] nothing more than to have [npc.her] armpits sexually serviced by [npc.her] partners, and even prefers it to penetrative sexual acts.");
			}
		}
	...
	public static AbstractFetish FETISH_PENIS_GIVING = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Unlocks</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>cock stud tease</span> (Requires penis)",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>cock addict tease</span>"),
			null) {
		@Override
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
	...
	public static AbstractFetish FETISH_DEFLOWERING = new AbstractFetish(60,
			...
			PresetColour.GENERIC_ARCANE,
			null,
			Util.newArrayListOfValues("Gain <span style='color:" + PresetColour.GENERIC_EXPERIENCE.toWebHexString()
					+ ";'>xp</span> from <span style='color:" + PresetColour.GENERIC_ARCANE.toWebHexString()
	...
	public static AbstractFetish FETISH_PURE_VIRGIN = new AbstractFetish(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(prize)] [npc.her] vaginal virginity above anything else in the world. If [npc.she] [npc.was] ever to lose it, [npc.she] [npc.do]n't know how [npc.she]'d cope...");

			} else {
				if (owner.hasFetish(FETISH_PURE_VIRGIN)) {
					return UtilText.parse(owner,
							"Although [npc.name] currently [npc.do]n't have a vagina, [npc.she] [npc.verb(know)] that if [npc.she] [npc.was] ever to have one, [npc.she]'d prize its virginity above anything else in the world.");

				} else {
					return UtilText.parse(owner,
							"As [npc.name] [npc.do]n't have a vagina, [npc.she] can't fetishise keeping its virginity...");
				}
			}
		}
	...
	public static AbstractFetish FETISH_MASTURBATION = new AbstractFetish(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"Using [npc.her] [npc.fingers] to get either [npc.herself] or [npc.her] partners to climax is one of [npc.namePos] favourite things to do during sex.");
			}
		}
	...
	public static AbstractFetish FETISH_IMPREGNATION = new AbstractFetish(60,
			...
			Util.newArrayListOfValues("<span style='color:"
					+ PresetColour.GENERIC_GOOD.toWebHexString() + ";'>Unlocks</span> <span style='color:"
					+ PresetColour.GENERIC_SEX.toWebHexString() + ";'>virility tease</span> (Requires penis)",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
	...
	public static AbstractFetish FETISH_PREGNANCY = new AbstractFetish(60,
			...
			Util.newArrayListOfValues("<span style='color:"
					+ PresetColour.GENERIC_GOOD.toWebHexString() + ";'>Unlocks</span> <span style='color:"
					+ PresetColour.GENERIC_SEX.toWebHexString() + ";'>fertility tease</span> (Requires vagina)",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Weak to</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>virility tease</span>"),
			null) {
	...
	public static AbstractFetish FETISH_TRANSFORMATION_GIVING = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Halves cost of all potion making</span>"),
			null) {
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] loves transforming others. Watching their bodies change, either voluntarily or otherwise, is a massive turn-on for [npc.herHim].");
			}
		}
	...
	public static AbstractFetish FETISH_TRANSFORMATION_RECEIVING = new AbstractFetish(60,
			...
			null,
			Util.newArrayListOfValues(
					"[style.boldGood(Increases potency)] <span style='color:"
							+ PresetColour.GENERIC_ARCANE.toWebHexString()
							+ ";'>of receiving forced transformations</span>",
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] loves being transformed. Having [npc.her] body parts changed, either voluntarily or otherwise, is a massive turn-on for [npc.herHim].");
			}
		}
	...
	public static AbstractFetish FETISH_KINK_GIVING = new AbstractFetish(60,
			...
			null,
			Util.newArrayListOfValues(
					// Unclear what extra effects this fetish should provide, other than triggering
					// forced fetishes
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Enjoy making others try new things!</span>"),
			null) {
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] loves giving others new fetishes. Watching them enjoy perverse new things, either voluntarily or otherwise, is a massive turn-on for [npc.herHim].");
			}
		}
	...
	public static AbstractFetish FETISH_KINK_RECEIVING = new AbstractFetish(60,
			...
			null,
			Util.newArrayListOfValues(
					// Unclear what extra effects this fetish should provide, other than not taking
					// corruption from receiving forced fetishes
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Removes corruption gain when a fetish is forced on you.</span>"),
			null) {
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] loves developing new fetishes. Gaining perverse joy from new things, either voluntarily or otherwise, is a massive turn-on for [npc.herHim].");
			}
		}
	...
	public static AbstractFetish FETISH_INCEST = new AbstractFetish(60,
			...
			null,
			Util.newArrayListOfValues(
					"Unlocks <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>incest tease</span>"),
			null) {
		@Override
		public String getDescription(GameCharacter owner) {
	...
	public static AbstractFetish FETISH_SADIST = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					...
					"[style.boldExcellent(+5%)] to all [style.colourHealth(" + Attribute.HEALTH_MAXIMUM.getName()
							+ " damage)]",
					"10% of all inflicted",
					"[style.colourHealth(" + Attribute.HEALTH_MAXIMUM.getName() + " damage)] is dealt",
					"back to you as <span style='color:" + Attribute.DAMAGE_LUST.getColour().toWebHexString()
							+ ";'>lust damage</span>",
	...
	public static AbstractFetish FETISH_MASOCHIST = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					...
					"25% of all incoming",
					"<span style='color:" + PresetColour.ATTRIBUTE_HEALTH.toWebHexString() + ";'>"
							+ Attribute.HEALTH_MAXIMUM.getName() + " damage</span>" + " is converted",
					" to <span style='color:" + Attribute.DAMAGE_LUST.getColour().toWebHexString()
							+ ";'>lust damage</span>",
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(get)] extremely turned on when subjected to painful or humiliating experiences."
	...
	public static AbstractFetish FETISH_NON_CON_DOM = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Increases</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>arousal gain when partner is resisting sex</span>"),
			null) {
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] has a fetish for non-consensual encounters. The more [npc.her] victim struggles, the more [npc.she] gets turned on...");
			}
		}
	...
	public static AbstractFetish FETISH_NON_CON_SUB = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Increases</span> <span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>arousal gain when you are resisting sex</span>"),
			null) {
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] has a fetish for being the victim in non-consensual encounters. Struggling and pleading to be released turns [npc.herHim] on like nothing else...");
			}
		}
	...
	public static AbstractFetish FETISH_BONDAGE_APPLIER = new AbstractFetish(60,
			...
			FetishExperience.BASE_EXPERIENCE_GAIN,
			Util.newArrayListOfValues(PresetColour.CLOTHING_BLACK_STEEL, PresetColour.CLOTHING_GOLD,
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(love)] binding people up in clothing that they're unable to remove, and then taking advantage of their immobility...");
			}
		}
	...
	public static AbstractFetish FETISH_BONDAGE_VICTIM = new AbstractFetish(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(love)] being bound up in clothing that [npc.sheIs] unable to remove, leaving [npc.herHim] at the mercy of others...");
			}
		}
	...
	public static AbstractFetish FETISH_EXHIBITIONIST = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Replaces</span> <span style='color:" + PresetColour.GENERIC_ARCANE.toWebHexString()
	...
	public static AbstractFetish FETISH_VOYEURIST = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
							+ ";'>Arousal boost</span> while watching sex scenes"),
			null) {
	...
	public static AbstractFetish FETISH_BIMBO = new AbstractFetish(60,
		...
		public List<String> getExtraEffects(GameCharacter owner) {
			if (owner == null || owner.isFeminine()) {
				return Util.newArrayListOfValues("<span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
						+ ";'>Talk like a bimbo</span>");
			} else {
				return Util.newArrayListOfValues("<span style='color:" + PresetColour.GENERIC_SEX.toWebHexString()
						+ ";'>Talk like a bro</span>");
			}
		}
	...
	public static AbstractFetish FETISH_CROSS_DRESSER = new AbstractFetish(60,
			...
			PresetColour.GENERIC_ARCANE,
			null,
			Util.newArrayListOfValues("<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(love)] wearing all manner of different clothing, and [npc.she] [npc.do]n't care if it's considered by others to be too masculine or feminine for [npc.her] body.");
			}
		}

		@Override
		public String getFetishDesireDescription(GameCharacter target, FetishDesire desire) {
			return getGenericFetishDesireDescription(target, desire,
					"wearing clothing more suited to the opposite gender");
		}
	...
	public static AbstractFetish FETISH_SIZE_QUEEN = new AbstractFetish(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] [npc.verb(prefer)] [npc.her] partners to be extremely well-endowed, and [npc.verb(love)] to feel them as deep inside of [npc.herHim] as physically possible.");
			}
		}
	...
	public static AbstractFetish FETISH_LUSTY_MAIDEN = new AbstractFetish(60,
			...
			Util.newArrayListOfValues(
					"<span style='color:" + PresetColour.GENERIC_GOOD.toWebHexString()
							+ ";'>Empowers</span> <span style='color:" + PresetColour.GENERIC_EXCELLENT.toWebHexString()
							+ ";'>'pure virgin'</span>",
					"<span style='color:" + PresetColour.GENERIC_BAD.toWebHexString()
							+ ";'>Amplifies</span> <span style='color:" + PresetColour.GENERIC_ARCANE.toWebHexString()
							+ ";'>'broken virgin'</span>"),
			null) {
		@Override
		...
		public String getDescription(GameCharacter owner) {
			if (owner == null) {
				...
				return UtilText.parse(owner,
						"[npc.Name] loves to pleasure others with [npc.her] ass, mouth, breasts, and even the promise of [npc.her] pussy,"
	...
	private static String getAppliedFetishAttackLevelEffectDescription(GameCharacter character, AbstractFetish fetish,
			String fetishAttackName) {
